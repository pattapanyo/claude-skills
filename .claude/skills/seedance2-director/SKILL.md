...
description: >-
  ...
  action scene, anime, claymation, comedy, fighting scene, or any visual sequence
  needing generation-ready prompts. Also trigger for: write me a video prompt,
  Seedance prompt, animate this, shot list, plan a video, make this cinematic,
  camera direction, AI video prompt, viral video prompt, @image1, omni reference,
  character reference, or any scene described in plain English that needs turning into
  Seedance video. The complete Seedance 2.0 system - Camera Bible + real viral prompt
  formats + both generation modes in one skill.
---
...
2. `references/seedance2-capabilities.md` — Seedance 2.0 exact features:
   ...
   both generation modes (T2V + I2V), and what the engine actually handles well
